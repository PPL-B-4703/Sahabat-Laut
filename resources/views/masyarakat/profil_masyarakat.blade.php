    ...
    <div class="relative w-full min-h-screen">
        ...
        <header class="fixed top-0 left-0 w-full h-[100px] flex items-center justify-between px-12 z-[100] bg-transparent">
            ...
            <div class="flex items-center gap-8">
                <a href="{{ route('masyarakat.profil.edit') }}" class="flex items-center gap-3 glass-card transition-all p-1 pr-4 rounded-full cursor-default shadow-[0_0_15px_rgba(255,255,255,0.2)] border-white/40">
        ...
        <div class="flex items-start pt-[120px] px-10 pb-10 gap-8 min-h-screen">
            ...
            <form action="{{ route('masyarakat.profil.update') }}" method="POST" enctype="multipart/form-data" class="flex-1 flex flex-col xl:flex-row gap-8 min-w-0" x-data="{ photoPreview: null }">
                @csrf
                @method('PUT')

                <aside class="w-full xl:w-80 h-fit rounded-[32px] glass-card p-8 flex flex-col items-center text-white shrink-0">
                    
                    <label class="relative w-32 h-32 rounded-full border-4 border-white/50 overflow-hidden mb-6 bg-white shadow-lg group cursor-pointer block">
                    ...
                    <div class="w-full flex flex-col gap-4 text-sm text-white/80">
                        <div class="flex items-center gap-4 bg-black/30 p-3 rounded-xl border border-white/10 overflow-hidden shadow-inner">
                ...
                <main class="flex-1 rounded-[32px] glass-card p-10 relative text-white flex flex-col min-h-[500px]">
                    <h2 class="text-2xl font-bold mb-8 glass-text border-b border-white/20 pb-4 tracking-wide">Ubah Profil</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                        <div class="h-[64px] border border-white/20 rounded-xl px-4 flex flex-col justify-center bg-black/30 focus-within:border-blue-400 focus-within:bg-black/40 transition-colors shadow-inner">
                            <label class="text-[11px] text-white/50 font-bold uppercase tracking-wider mb-1">First Name</label>
                        ...
                        <div class="h-[64px] border border-white/20 rounded-xl px-4 flex flex-col justify-center bg-black/30 focus-within:border-blue-400 focus-within:bg-black/40 transition-colors shadow-inner">
                            <label class="text-[11px] text-white/50 font-bold uppercase tracking-wider mb-1">Last Name</label>
                        ...
                        <div class="h-[64px] border border-white/20 rounded-xl px-4 flex flex-col justify-center bg-black/30 focus-within:border-blue-400 focus-within:bg-black/40 transition-colors shadow-inner">
                            <label class="text-[11px] text-white/50 font-bold uppercase tracking-wider mb-1">Email</label>
                        ...
                        <div class="h-[64px] border border-white/20 rounded-xl px-4 flex flex-col justify-center bg-black/30 focus-within:border-blue-400 focus-within:bg-black/40 transition-colors shadow-inner">
                            <label class="text-[11px] text-white/50 font-bold uppercase tracking-wider mb-1">Password Baru</label>
                        ...
                        <div class="h-[64px] border border-white/20 rounded-xl px-4 flex flex-col justify-center bg-black/30 focus-within:border-blue-400 focus-within:bg-black/40 transition-colors shadow-inner md:col-span-2">
                            <label class="text-[11px] text-white/50 font-bold uppercase tracking-wider mb-1">Nomor HP</label>
                    ...
                    <div class="mt-auto flex justify-end">
                        <button type="submit" class="px-10 py-3.5 bg-blue-500 hover:bg-blue-600 rounded-xl font-bold text-white transition-all shadow-[0_4px_15px_rgba(59,130,246,0.4)] transform hover:-translate-y-1 active:scale-95">
                            Simpan Perubahan
                        </button>
                    </div>
                </main>
