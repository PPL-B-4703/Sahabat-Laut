    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-lg p-8">
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
                ...
                <!-- Password -->
                <div>
                    <label for="password" class="block text-sm font-bold text-slate-100 mb-2">Password <span class="text-red-400">*</span></label>
                    <input 
                        type="password" 
                        id="password" 
                        name="password" 
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-bold text-slate-100 mb-2">Konfirmasi Password <span class="text-red-400">*</span></label>
                    <input 
                        type="password" 
                ...
                <div>
                    ...
                    <select 
                        ...
                        @foreach($roles as $role)
                            <option value="{{ $role }}" @selected(old('role') === $role) class="bg-slate-800 text-slate-100">
                                {{ ucfirst($role) }}
                            </option>
                        @endforeach
                    </select>
